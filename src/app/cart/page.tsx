...
export default function CartPage() {
  const [cart, setCart] = useState([
    {
      id: "97781940722984",
      name: "هامر اچ۲ مدل ۲۰۲۲",
      image: "https://paultan.org/image/2021/04/2024-GMC-Hummer-EV-SUV-4.jpg",
  ...
  return (
    <div className="bg-[#f9f9f9]">
      ...
      <div className="p-5 bg-[#f9f9f9] min-h-screen pb-[180px]">
        {cart.length === 0 ? (
        ...
        {cart.length > 0 && (
          <div className="rounded-t-full fixed bottom-0 left-0 w-full backdrop-blur-md bg-white/80 border-t border-gray-200 shadow-[0_-4px_30px_rgba(0,0,0,0.35)] p-5 z-50">
            <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <button className="flex items-center justify-center gap-2 px-10 py-3 bg-gradient-to-l from-[#ec8c2f] to-[#e07e1f] text-white text-lg sm:text-xl font-bold rounded-full shadow-[0_4px_16px_rgba(0,0,0,0.4)] hover:shadow-[0_6px_20px_rgba(0,0,0,0.6)] hover:scale-[1.03] transition-all duration-300 ease-in-out">
