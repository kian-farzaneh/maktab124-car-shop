      ...
      <div>
        <header className="bg-[#ec8c2f] py-3 px-1">
          ...
          <div className="search-box flex items-center justify-center mt-9 ">
            <button className="bg-white text-[#ec8c2f] ml-[-3px] pr-3 h-12 rounded-r-lg"><CiSearch size={34} /></button>
            <input type="text" className="bg-white outline-none w-[290px] pr-2 h-12 rounded-l-lg" />
          </div>
        </header>
        <HomePageFilter />
